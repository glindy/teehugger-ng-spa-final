...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/baby",  {templateUrl: "partials/baby.html", controller: 'PageCtrl', title: 'for the babes',
    	pageName: 'Product:Category:Baby', pageType: 'Category', siteSection: 'Home', siteSubsection: 'Department'})
    	
    .when("/kids",  {templateUrl: "partials/kids.html", controller: 'PageCtrl', title: 'for the kiddos',
    	pageName: 'Product:Category:Kids', pageType: 'Category', siteSection: 'Home', siteSubsection: 'Department'})
    	
    .when("/mens",  {templateUrl: "partials/mens.html", controller: 'PageCtrl', title: 'for the guys',
    	pageName: 'Product:Category:Mens', pageType: 'Category', siteSection: 'Home', siteSubsection: 'Department'})
    	
    .when("/womens",  {templateUrl: "partials/womens.html", controller: 'PageCtrl', title: 'for the gals',
    	pageName: 'Product:Category:Womens', pageType: 'Category', siteSection: 'Home', siteSubsection: 'Department'})
    ...
    .when("/babycrew",  {templateUrl: "partials/babycrew.html", controller: 'PageCtrl', title: 'baby crew onesie', 
    	pageName: 'Product:Baby:Crew', pageType: 'Product', siteSection: 'Baby', siteSubsection: 'Crew',
    ...
    .when("/baby-v",  {templateUrl: "partials/baby-v.html", controller: 'PageCtrl', title: 'baby v onesie',
    	pageName: 'Product:Baby:V', pageType: 'Product', siteSection: 'Baby', siteSubsection: 'V Neck',
    ...
    .when("/kids-crew",  {templateUrl: "partials/kids-crew.html", controller: 'PageCtrl', title: 'kids crew neck',
    	pageName: 'Product:Kids:Crew', pageType: 'Product', siteSection: 'Kids', siteSubsection: 'Crew',
    	productID: '34567', productName: 'Kids Crew', revenue: '19.99'})
    	
    .when("/kids-v",  {templateUrl: "partials/kids-v.html", controller: 'PageCtrl', title: 'kids v neck',
    ...
    .when("/mens-crew",  {templateUrl: "partials/mens-crew.html", controller: 'PageCtrl', title: 'mens crew neck',
    ...
    .when("/mens-v",  {templateUrl: "partials/mens-v.html", controller: 'PageCtrl', title: 'mens v neck',
    	pageName: 'Product:Mens:V', pageType: 'Product', siteSection: 'Mens', siteSubsection: 'V Neck', 
    ...
    .when("/womens-crew",  {templateUrl: "partials/womens-crew.html", controller: 'PageCtrl', title: 'womens crew neck',
    	pageName: 'Product:Womens:Crew', pageType: 'Product', siteSection: 'Womens', siteSubsection: 'Crew',
    ...
    .when("/womens-v",  {templateUrl: "partials/womens-v.html", controller: 'PageCtrl', title: 'womens v neck',
    	pageName: 'Product:Womens:V', pageType: 'Product', siteSection: 'Womens', siteSubsection: 'V Neck', 
    	productID: '89101', productName: 'Womens V', revenue: '29.99'})
    
    // Checkout Confirmation Pages
    .when("/checkout-bc",  {templateUrl: "partials/checkout-bc.html", controller: 'bcCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Baby:Crew', pageType: 'Checkout', siteSection: 'Baby', siteSubsection: 'Crew', 
    	productID: '12345', productName: 'Baby Crew', revenue: '10.99',
    	productTotalRevenue: '29.99', productTotalUnits: '2'})
    	
    .when("/checkout-bv",  {templateUrl: "partials/checkout-bv.html", controller: 'bvCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Baby:V', pageType: 'Checkout', siteSection: 'Baby', siteSubsection: 'V Neck', 
    	productID: '23456', productName: 'Baby V', revenue: '10.99',
    	productTotalRevenue: '32.97', productTotalUnits: '3'})
    	
    .when("/checkout-kc",  {templateUrl: "partials/checkout-kc.html", controller: 'kcCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Kids:Crew', pageType: 'Checkout', siteSection: 'Kids', siteSubsection: 'Crew', 
    	productID: '34567', productName: 'Kids Crew', revenue: '19.99',
    	productTotalRevenue: '59.97', productTotalUnits: '3'})
    	
    .when("/checkout-kv",  {templateUrl: "partials/checkout-kv.html", controller: 'kvCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Kids:V', pageType: 'Checkout', siteSection: 'Kids', siteSubsection: 'V Neck', 
    	productID: '45678', productName: 'Kids V', revenue: '19.99',
    	productTotalRevenue: '79.96', productTotalUnits: '4'})
    	
    .when("/checkout-mc",  {templateUrl: "partials/checkout-mc.html", controller: 'mcCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Mens:Crew', pageType: 'Checkout', siteSection: 'Mens', siteSubsection: 'Crew', 
    	productID: '56789', productName: 'Mens Crew', revenue: '24.99',
    	productTotalRevenue: '49.98', productTotalUnits: '2'})
    	
    .when("/checkout-mv",  {templateUrl: "partials/checkout-mv.html", controller: 'mvCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Mens:V', pageType: 'Checkout', siteSection: 'Mens', siteSubsection: 'V Neck', 
    	productID: '67891', productName: 'Mens V', revenue: '24.99',
    	productTotalRevenue: '24.99', productTotalUnits: '1'})
    	
    .when("/checkout-wc",  {templateUrl: "partials/checkout-wc.html", controller: 'wcCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Womens:Crew', pageType: 'Checkout', siteSection: 'Womens', siteSubsection: 'Crew', 
    	productID: '78910', productName: 'Womens Crew', revenue: '29.99',
    	productTotalRevenue: '119.96', productTotalUnits: '4'})
    	
    .when("/checkout-wv",  {templateUrl: "partials/checkout-wv.html", controller: 'wvCheckoutCtrl', title: 'thank you',
    	pageName: 'Checkout:Womens:V', pageType: 'Checkout', siteSection: 'Womens', siteSubsection: 'V Neck', 
    	productID: '89101', productName: 'Womens V', revenue: '29.99',
...
app.run(['$rootScope', '$route', function($rootScope, $route) { 
    $rootScope.$on('$routeChangeSuccess', function() {
        ...
        $rootScope.pageName = $route.current.pageName; // added this
	...
	$rootScope.$on('$routeChangeSuccess', function() { 
		// Update Data Layer
		digitalData.page.pageName = $rootScope.pageName; // changed this from document.title
...
/**
 * Controls client-side purchase ID on Checkout Confirmation Pages
 */
